...
[**NEW!**] Emozzk Lite 설정 화면에서 세트 전환 단축키를 지정할 수 있습니다.
- 기본값 미지정
- ctrl + ←, crtl + → 등으로 지정
...
브라우저 우측 상단의 확장 프로그램 아이콘🧩을 누르면 Emozzk Lite 설정 화면을 열 수 있습니다.
...
<p>
  <img src="./assets/pngs/popup.png" width="332" alt="Emozzk Lite 확장 프로그램 팝업 설정">
</p>
